...
void DeckLight::Setup()
{
  ...
  // Setup deck LEDs
  FastLED.addLeds<WS2812B, DECK_LED_PIN, EOrder::GRB>(vuLeds, DeckVuLedCount).setCorrection(TypicalSMD5050);
}
...
void DeckLight::UpdateAnalogVuMeter()
{
  ...
  float variance = random(100 - AnalogVUVariance, 100 + AnalogVUVariance) / 100.0;
